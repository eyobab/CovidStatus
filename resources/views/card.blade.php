                    ...
                    <div class="col-xl-8 p-4 m-auto shadow">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="card-title text-info"> Add Info </h5>
                            </div>
                        <div class="card-body">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 m-auto">
                                            ...
                                            <div class="form-group" {{ $errors->has('zipcode') ? 'has-error' : ''}}>
                                             ...
                                             <div class="form-group" {{ $errors->has('zipcode') ? 'has-error' : ''}}>
                                                <label> Neer A suspect </label>
                                                <input type="checkbox" name="zipcode" class="checkbox" placeholder="ture" value="{{ old('suspect') }}">
                                                {!! $errors->first('suspect', '<small class="text-danger">:message </small>') !!}
                                            </div>
                                        </div>
                                    </div>
